-- ELEV8 Database Schema - INFINITE RECURSION FIX (CORRECTED)
-- This script fixes the infinite recursion issue in RLS policies
-- FIXED: Uses public schema instead of auth schema for the function

-- Step 1: Create a security definer function in the PUBLIC schema
...
-- Use the public schema function instead of a subquery to prevent recursion
...
SELECT 'Function created successfully in public schema. You can test with: SELECT public.is_app_admin();' as status;
